...
| Managed Identity | App registration (`PowerPlatform-Demo`), granted **Cognitive Services OpenAI User** on the Azure OpenAI resource. No client secrets — token acquired at runtime by `IManagedIdentityService`. |
